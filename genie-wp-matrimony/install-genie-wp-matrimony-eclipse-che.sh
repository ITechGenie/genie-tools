...
echo "============================="
apt-get install apache2 php libapache2-mod-php  mysql-client php-mysql perlbrew wget tar zip unzip pv composer subversion phpunit
wget https://raw.githubusercontent.com/wp-cli/builds/gh-pages/phar/wp-cli.phar
php wp-cli.phar --info
chmod +x wp-cli.phar
sudo mv wp-cli.phar /usr/local/bin/wp
echo "================================="
echo "Restart Apache (Recommended for new installations)? (y/n)"
read -e restartserv
